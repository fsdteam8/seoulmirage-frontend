      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              {isSearchOpen ? (
                <div className="flex items-center">
                  <Input type="text" placeholder="Search..." className="w-48 sm:w-64 pr-10 text-sm" autoFocus />
                  <Button
                    variant="ghost"
                    size="sm"
                ...
                <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={() => setIsSearchOpen(true)}>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem>
                  <Link href="/signin" className="w-full font-raleway">
                    Sign in
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link href="/signup" className="w-full font-raleway">
                    Sign up
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem className="text-red-600 font-raleway">Log Out</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
        ...
        {isSearchOpen && (
          <div className="lg:hidden py-3 border-t border-gray-200">
            <div className="relative">
              <Input type="text" placeholder="Search..." className="w-full pr-10 text-sm font-raleway" autoFocus />
              <Button
                variant="ghost"
                size="sm"
                className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0"
